...
require_no_postulates() {
  ...
  local paths=(
    ...
    "$AGDA_DIR/Test/SemanticFixtureSmoke.agda"
    "$AGDA_DIR/Test/SemanticDepthSmoke.agda"
    "$AGDA_DIR/Test/FibonacciScalingSmoke.agda"
...
run_agda "Semantics/CubicalFoundation.agda"
run_agda "Semantics/SealedExtension.agda"
run_agda "Semantics/PrimitiveTrace.agda"
run_agda "Semantics/RawAdequacy.agda"
run_agda "Semantics/TraceNormalForm.agda"
run_agda "Semantics/SemanticHornReduction.agda"
run_agda "Semantics/DepthUpperBound.agda"
run_agda "Semantics/DepthLowerBound.agda"
run_agda "Semantics/ExactDepth.agda"
run_agda "Semantics/ChronologicalWindow.agda"
run_agda "Semantics/FullCoupling.agda"
run_agda "Semantics/ScalingRecurrence.agda"
run_agda "Semantics/FibonacciScaling.agda"
...
run_agda "CaseStudies/HigherPayload.agda"
run_agda "Test/HigherPayloadSmoke.agda"
run_agda "Test/SemanticFixtureSmoke.agda"
run_agda "Test/SemanticDepthSmoke.agda"
run_agda "Test/FibonacciScalingSmoke.agda"
