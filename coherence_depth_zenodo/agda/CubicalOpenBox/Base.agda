...
record StructuralOpenBox (ℓ : Level) : SSet (ℓ-suc ℓ) where
  ...
  field
    ...
    structuralCompatibleLids : Type ℓ
    structuralCompatibleLidPoint :
      structuralCompatibleLids → structuralA
    structuralCompatibleLidsBoundaryWitness : Type ℓ
    structuralCompatibleLidsBoundaryWitnessProof :
      structuralCompatibleLidsBoundaryWitness
    structuralSideEquations : Type ℓ
    structuralSideEquationsHold : structuralSideEquations
    structuralEndpointLaws : Type ℓ
    structuralEndpointLawsHold : structuralEndpointLaws
    structuralSubstitutionStability : Type ℓ
    structuralSubstitutionStabilityProof :
      structuralSubstitutionStability
...
structuralCompatibleLidType :
  (ob : StructuralOpenBox ℓ) →
  Type ℓ
structuralCompatibleLidType = structuralCompatibleLids
